...
// that with 405. The page is open by design — the client approves channel
// joins by hand and needs the URL to load for pixel setup. The Playwright
// web server here is a plain static server, so the handler is exercised
// in-process with a stub req/res.
